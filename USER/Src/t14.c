...
//  //发球动作参数：�?�度单位沿用当前达�?�电�? angle 标定，时间单位为 10ms 控制周期
...
// static volatile float damiao0_tarangle=0.0f;//达�?�电�?0�?标�?�度
// static volatile uint8_t count=0; //达�?�电机回零�?�数
...
//    default:
//      //  damiao[0].angle = -0.25f; // 保持�?球机构位�?不变
...
// //         damiao[0].angle = 0.0f; // 保持�?球机构位�?不变
// //         //damiao[1].angle = 1.0f - 2.6f * progress; // �? 1.8f 平滑过渡�? -0.8f
// // 		damiao[1].angle=2.2f;
// //		  
// //         if(++serve_tick >= SERVE_HIT_RETURN_TICKS)
// //         {
...
// //             returning=1;
// //             return_tick = 0;
// //             return_start_angle=damiao[0].angle; // 记录开始回零时的�?�度
// //         }
// //     }
// //     if(returning){
